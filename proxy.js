...
const overallAgentsDataRouting = {
  "/assetmgmt/patch/status": (agentId) =>
    `/api/v1.0/assetmgmt/patch/${agentId}/status`,
  "/assetmgmt/patch/history": (agentId) =>
    `/api/v1.0/assetmgmt/patch/${agentId}/history`,
};
...
http
  .createServer(async (req, res) => {
    ...
    res.setHeader(
      "Content-Type",
      `application/${reqInfo.accept}; charset=utf-8`
    );
